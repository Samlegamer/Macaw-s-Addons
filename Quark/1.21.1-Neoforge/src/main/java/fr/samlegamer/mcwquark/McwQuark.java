...
public class McwQuark extends McwMod
{
	...
	private static final DeferredRegister.Blocks BLOCKS = Registration.blocks(MODID);
	private static final DeferredRegister.Items ITEMS = Registration.items(MODID);
	...
	public McwQuark(IEventBus bus)
    {
		...
		Registration.init(bus, BLOCKS, ITEMS, CT);
