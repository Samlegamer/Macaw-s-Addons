...
public class McwTerraformersMC implements ModInitializer
{
    ...
    public void onInitialize()
    {
        ...
        McwCommon.addCompatibleBlocksToFurnitureStorage(McwTerraformersMC.MODID, McwTerraformersMC.WOODS_TRAVERSE);
        McwCommon.addCompatibleBlocksToFurnitureStorage(McwTerraformersMC.MODID, McwTerraformersMC.WOODS_CINDERSCAPES);
        McwCommon.addCompatibleBlocksToFurnitureStorage(McwTerraformersMC.MODID, McwTerraformersMC.WOODS_TERRESTRIA);
