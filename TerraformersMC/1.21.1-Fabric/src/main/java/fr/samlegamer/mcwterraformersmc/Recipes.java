...
public class Recipes extends McwRecipes
{
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        recipesUtils.registerAllMcwWood(recipeExporter, McwTerraformersMC.MODID, Cinderscapes.MOD_ID, McwTerraformersMC.WOODS_CINDERSCAPES, getWoodMatsCinderscapes());
        recipesUtils.registerAllMcwStone(recipeExporter, McwTerraformersMC.MODID, Cinderscapes.MOD_ID, McwTerraformersMC.ROCKS_CINDERSCAPES, getRockMatsCinderscapes());
