...
public class Recipes extends McwRecipes
{
    public Recipes(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
        super(output, registriesFuture, McwTerraformersMC.MODID, "", "");
    }
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        registerAllMcwWood(recipeExporter, McwTerraformersMC.MODID, Cinderscapes.MOD_ID, McwTerraformersMC.WOODS_CINDERSCAPES, getWoodMatsCinderscapes());
        registerAllMcwStone(recipeExporter, McwTerraformersMC.MODID, Cinderscapes.MOD_ID, McwTerraformersMC.ROCKS_CINDERSCAPES, getRockMatsCinderscapes());
