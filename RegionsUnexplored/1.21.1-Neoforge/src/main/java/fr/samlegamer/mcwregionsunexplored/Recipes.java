...
public class Recipes extends McwRecipes
{
    ...
    protected void buildRecipes(@NotNull RecipeOutput consumer) {
        registerAllMcwWood(consumer, McwRegionsUnexplored.MODID, Constants.MOD_ID, McwRegionsUnexplored.WOOD, getWoodMat());
        registerMcwHedge(consumer, McwRegionsUnexplored.MODID, Constants.MOD_ID, McwRegionsUnexplored.LEAVES, getLeavesMat());
    }
