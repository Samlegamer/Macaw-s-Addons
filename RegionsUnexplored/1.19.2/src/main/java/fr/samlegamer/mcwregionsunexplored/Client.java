...
public class Client
{
	...
	/*TODO:
	 * for specifics block like two silver_birch_hedge and enchanted_birch_hedge, do not used local var, like :
	 * public static final Block block = Finder.findBlock(McwRegionsUnexplored.MODID, "silver_birch_hedge");
	 */
	@SubscribeEvent
	public static void colorsBlock(RegisterColorHandlersEvent.Block event)
	{
		COLOR.registryBlockColors(event);
		event.register((bs, world, pos, index) -> world != null && pos != null ?
				getAspenColor(world, pos) : FoliageColor.getDefaultColor(), Finder.findBlock(McwRegionsUnexplored.MODID, "silver_birch_hedge"));
		event.register((bs, world, pos, index) -> world != null && pos != null ?
				getEnchantedAspenColor(world, pos) : FoliageColor.getDefaultColor(), Finder.findBlock(McwRegionsUnexplored.MODID, "enchanted_birch_hedge"));
	}
