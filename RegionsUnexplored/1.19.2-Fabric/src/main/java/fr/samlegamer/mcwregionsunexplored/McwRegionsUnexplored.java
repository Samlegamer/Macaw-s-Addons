...
public class McwRegionsUnexplored implements ModInitializer {
    ...
    public static final ItemGroup MCWREGIONUNEXPLORED_TAB = FabricItemGroupBuilder.build(new Identifier(MODID, "tab"), McwRegionsUnexplored::makeIcon);

    @Override
    public void onInitialize() {
        LOGGER.info("Macaw's Regions Unexplored Loading...");
        McwRegistry.setRegistriesWood(MODID, WOOD, MCWREGIONUNEXPLORED_TAB, ModType.getAllModTypeWood());
        McwRegistry.setRegistriesLeave(MODID, LEAVES, MCWREGIONUNEXPLORED_TAB);
