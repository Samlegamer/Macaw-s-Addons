...
public class Recipes extends McwRecipes {
    protected Recipes(PackOutput packOutput) {
        super(packOutput, McwBOP.MODID, "", BiomesOPlenty.MOD_ID);
    }
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> recipeOutput) {
        ...
        registerMcwHedge(recipeOutput, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.LEAVE, leave);
    }
