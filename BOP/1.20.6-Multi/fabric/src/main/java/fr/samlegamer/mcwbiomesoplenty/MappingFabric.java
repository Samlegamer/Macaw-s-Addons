...
public class MappingFabric
{
	private MappingFabric() {}
		
	public static void configDataFixerFiles()
	{
        File folder = FabricLoader.getInstance().getConfigDir().resolve("configurable_everything").toFile();
        ...
        File file = FabricLoader.getInstance().getConfigDir().resolve("configurable_everything/datafixer.FORBOPRENAMETHISdjs").toFile();
				...
				for(String i : McwBOP.WOOD)
				{
	    			...
	    			for (int blockIndex = 0; blockIndex < blocksFurnitures.length; blockIndex++) {
	    	            String block = blocksFurnitures[blockIndex];
	    	            		...
	    	            		buffer.write("          {\r\n"
    	            		+ "            old_id: 'mcwfurnituresbop:"+block+"'\r\n"
    	            		+ "            new_id: '"+ McwBOP.MODID+":"+block+"'\r\n"
    	            		+ "          }\r\n");
	    			}
	    			buffer.write( "        ]\r\n"
            		+ "      }\r\n");
				...
				buffer.write( "]\r\n"
					...
					for(String i : McwBOP.WOOD)
					{
		    			...
		    			for (int blockIndex = 0; blockIndex < blocksFurnitures.length; blockIndex++) {
		    	            String block = blocksFurnitures[blockIndex];
		    	            buffer.write("        {\n");
		    	            buffer.write("          old_id: '" + "mcwfurnituresbop" + ":" + block + "'\n");
		    	            buffer.write("          new_id: '" + McwBOP.MODID + ":" + block + "'\n");
		    	            buffer.write("        }");
		    			...
		    			for (int blockIndex = 0; blockIndex < blocksRoofs.length; blockIndex++) {
		    	            String block = blocksRoofs[blockIndex];
		    	            buffer.write("        {\n");
		    	            buffer.write("          old_id: '" + "macawsroofsbop" + ":" + block + "'\n");
		    	            buffer.write("          new_id: '" + McwBOP.MODID + ":" + block + "'\n");
		    	            buffer.write("        }");
		    			...
		    			for (int blockIndex = 0; blockIndex < blocksFencesWood.length; blockIndex++) {
		    	            String block = blocksFencesWood[blockIndex];
		    	            buffer.write("        {\n");
		    	            buffer.write("          old_id: '" + "mcwfencesbop" + ":" + block + "'\n");
		    	            buffer.write("          new_id: '" + McwBOP.MODID + ":" + block + "'\n");
		    	            buffer.write("        }");
		    			...
		    			for (int blockIndex = 0; blockIndex < blocksBridgesWood.length; blockIndex++) {
		    	            String block = blocksBridgesWood[blockIndex];
		    	            buffer.write("        {\n");
		    	            buffer.write("          old_id: '" + "macawsbridgesbop" + ":" + block + "'\n");
		    	            buffer.write("          new_id: '" + McwBOP.MODID + ":" + block + "'\n");
		    	            buffer.write("        }");
