...
public class Recipes extends McwRecipes {
    protected Recipes(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries) {
        super(packOutput, registries, McwBOP.MODID, BiomesOPlenty.MOD_ID, "");
    }
    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        List<Block> leave = List.of(DEAD_LEAVES, FIR_LEAVES, HELLBARK_LEAVES, JACARANDA_LEAVES, MAGIC_LEAVES, MAHOGANY_LEAVES,
                ...
                RED_MAPLE_LEAVES, YELLOW_MAPLE_LEAVES, CYPRESS_LEAVES, SNOWBLOSSOM_LEAVES, FLOWERING_OAK_LEAVES, RAINBOW_BIRCH_LEAVES, ORIGIN_LEAVES);
        List<McwWoodMat> woodMats = getWoodMats();
        registerAllMcwWood(recipeOutput, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.WOOD, woodMats);
        registerMcwHedge(recipeOutput, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.LEAVES, leave);
    }
