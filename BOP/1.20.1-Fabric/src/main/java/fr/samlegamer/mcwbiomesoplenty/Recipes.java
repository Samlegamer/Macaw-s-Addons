...
public class Recipes extends McwRecipes
{
    ...
    public void generate(Consumer<RecipeJsonProvider> recipeExporter) {
        ...
        recipesUtils.registerAllMcwWood(recipeExporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.WOOD, woodMats);
        recipesUtils.registerMcwHedge(recipeExporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.LEAVES, leave);
    }
