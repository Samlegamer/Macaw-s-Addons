...
public class Recipes extends FabricRecipeProvider
{
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                McwRecipes.registerAllMcwWood(this, recipeExporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.WOOD, woodMats);
                McwRecipes.registerMcwHedge(this, recipeExporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.LEAVES, leave);
            }
        };
    }
    ...
    public String getName() {
        return McwBOP.MODID + " Recipes Generator";
    }
}