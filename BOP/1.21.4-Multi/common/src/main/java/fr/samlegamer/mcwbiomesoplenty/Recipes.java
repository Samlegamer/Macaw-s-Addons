...
public class Recipes {
    ...
    public static final String MODID = BiomesOPlenty.MOD_ID;

    public static List<Block> getLeaveMats() {
        return List.of(DEAD_LEAVES, FIR_LEAVES, HELLBARK_LEAVES, JACARANDA_LEAVES, MAGIC_LEAVES, MAHOGANY_LEAVES,
    ...
    public static List<McwWoodMat<Block>> getWoodMats() {
