...
public class Recipes extends McwRecipes
{
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        registerAllMcwWood(recipeExporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.WOOD, woodMats);
        registerMcwHedge(recipeExporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.LEAVES, leave);
    }
