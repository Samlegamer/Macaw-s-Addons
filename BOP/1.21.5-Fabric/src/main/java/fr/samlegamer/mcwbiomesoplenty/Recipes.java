...
public class Recipes extends McwRecipes
{
    public Recipes(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
        super(output, registriesFuture, McwBOP.MODID, "", BiomesOPlenty.MOD_ID);
    }
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup registryLookup, RecipeExporter exporter) {
        return new RecipeGenerator(registryLookup, exporter) {
            ...
            public void generate() {
                ...
                registerAllMcwWood(this, this.exporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.WOOD, woodMats);
                registerMcwHedge(this, this.exporter, McwBOP.MODID, BiomesOPlenty.MOD_ID, McwBOP.LEAVES, leave);
            }
        };
    }
