...
public class McwBygNeoForge extends McwMod
{
    ...
    public void dataSetup(GatherDataEvent gatherDataEvent) {
        ...
        {
            McwBlockTags mcwBlockTags = new McwBlockTags(output, registries, McwByg.MODID, existingFileHelper) {
                @Override
            ...
            generator.addProvider(true, new McwItemTags(output, registries, mcwBlockTags.contentsGetter(), McwByg.MODID, existingFileHelper) {
                @Override
                protected void addTags(HolderLookup.@NotNull Provider provider) {
					addAllMcwTagsWood(McwByg.MODID, McwByg.WOOD, ModType.getAllModTypeWood());
					addAllMcwTagsStone(McwByg.MODID, McwByg.STONE, ModType.getAllModTypeStone());
