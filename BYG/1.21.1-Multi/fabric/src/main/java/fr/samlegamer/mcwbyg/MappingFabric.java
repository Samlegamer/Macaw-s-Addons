...
public final class MappingFabric
{
	...
	public static void configDataFixerFiles()
	{
        ...
        File file = FabricLoader.getInstance().getConfigDir().resolve("configurable_everything/datafixer.FORBWGRENAMETHISdjs").toFile();
