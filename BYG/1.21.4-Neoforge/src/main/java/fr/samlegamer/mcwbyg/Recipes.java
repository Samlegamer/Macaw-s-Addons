...
public class Recipes extends McwRecipes {
    public Recipes(HolderLookup.Provider registries, RecipeOutput output) {
        super(registries, output, McwByg.MODID, "", BiomesWeveGone.MOD_ID);
    }

    @Override
    protected void buildRecipes() {
        McwByg.LOGGER.info("size LEAVES  " + McwByg.LEAVES.size());
        McwByg.LOGGER.info("size getLeaveMat  " + getLeaveMat().size());

        registerAllMcwWood(output, McwByg.MODID, BiomesWeveGone.MOD_ID, McwByg.WOOD, getWoodMat());
        registerMcwHedge(output, McwByg.MODID, BiomesWeveGone.MOD_ID, McwByg.LEAVES, getLeaveMat());
        registerAllMcwStone(output, McwByg.MODID, BiomesWeveGone.MOD_ID, McwByg.STONE, getStoneMat());
    }
    ...
    public static class Runner extends McwRecipes.Runner {
