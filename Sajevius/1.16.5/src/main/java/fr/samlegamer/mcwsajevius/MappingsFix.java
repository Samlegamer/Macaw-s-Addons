...
{
	private static final MappingMissing.Bridges bridges_betterlands = new MappingMissing.Bridges("mcwbridgesaurora", McwSajevius.MODID, McwSajevius.wood_betterlands, McwSajevius.stone_betterlands);
	private static final MappingMissing.Bridges bridges_shroomed = new MappingMissing.Bridges("mcwbridgesaurora", McwSajevius.MODID, McwSajevius.wood_shroomed);
