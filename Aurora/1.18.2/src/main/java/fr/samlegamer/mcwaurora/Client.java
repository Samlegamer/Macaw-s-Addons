...
public class Client
{
	...
	public static void colorsBlock(ColorHandlerEvent.Block event)
	{
		 ...
		 */
		event.getBlockColors().register((state, view, pos, tintIndex) -> view != null && pos != null ? BiomeColors.getAverageFoliageColor(view, pos) : FoliageColor.getDefaultColor(), Finder.findBlock(McwAurora.MODID, "cypress_hedge"));
	...
	{
		event.getItemColors().register((stack, tintIndex) -> FoliageColor.getDefaultColor(), Finder.findBlock(McwAurora.MODID, "cypress_hedge"));
