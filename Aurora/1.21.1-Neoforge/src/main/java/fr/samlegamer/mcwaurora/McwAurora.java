...
public class McwAurora extends McwMod
{
    ...
    public McwAurora(IEventBus modBus)
    {
    	...
    	RegistrationNeoForge.init(modBus, block, item, ct);
		final List<String> leaveClassic = List.of("maple", "pine", "walnut", "willow", "autumnal_oak", "frosted", "yellow_birch", "red_maple");
		Map<String, SoundType> leaveSoundCherry = RegistryUtils.makeDefaultFromList(List.of("pale_cherry"), SoundType.CHERRY_LEAVES);

		McwRegistry.setRegistriesWood(WOOD_ENHANCED_MUSH, block, item, ModType.getAllModTypeWood());
		McwRegistry.setRegistriesWood(WOOD_NOMANSLAND, block, item, ModType.getAllModTypeWood());
    ...
    public void clientSetup(FMLClientSetupEvent event) {
        ...
        APIRenderTypes.initAllWood(event, MODID, WOOD_NOMANSLAND, ModType.getAllModTypeWood());
    ...
    public void commonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            McwLootTables.LOOT_TABLE_UTILS.addBlockAllWood(MODID, WOOD_NOMANSLAND);
            McwLootTables.LOOT_TABLE_UTILS.addBlockHedges(MODID, LEAVE_NOMANSLAND);
        });
    }
        ...
        if(gatherDataEvent.includeServer()) {
            McwBlockTags mcwBlockTags = new McwBlockTags(output, registries, MODID, existingFileHelper) {
                ...
                protected void addTags(HolderLookup.@NotNull Provider provider) {
					...
					addAllMcwTagsWood(MODID, WOOD_NOMANSLAND, ModType.getAllModTypeWood());
    ...
    public void tabSetup(BuildCreativeModeTabContentsEvent event) {
        ...
        if (modList.isLoaded("enhanced_mushrooms")) {
            APICreativeTab.initAllWood(event, MODID, WOOD_ENHANCED_MUSH, MCWAURORA_TAB.get(), ModType.getAllModTypeWood());
        }

        if (modList.isLoaded("nomansland")) {
            APICreativeTab.initAllWood(event, MODID, WOOD_NOMANSLAND, MCWAURORA_TAB.get(), ModType.getAllModTypeWood());
